![image](https://github.com/user-attachments/assets/8ff2b2a4-86ff-4226-816e-4c51c8fa530a)#  Курсовая работа на профессии "DevOps-инженер с нуля" Барсуков А.А
...
Репозиторий содержит в себе проект и папки с конфигурационными файлами необходимыми для проекта.

В папке Terraform находится файлы необходимые для создания инфраструктуры в Yandex Cloud.
